...
const Footer = () => {
    ...
    return (
        <footer className="bg-gradient-to-b from-[#2B2B2B] to-[#1A1A1A] text-white py-8 xs:py-10 sm:py-12 md:py-14 lg:py-16 relative overflow-hidden" role="contentinfo">
            <div className="absolute inset-0 opacity-5">
                <div className="absolute top-0 left-0 w-24 h-24 xs:w-28 xs:h-28 sm:w-32 sm:h-32 bg-[#800000] rounded-full blur-3xl"></div>
                <div className="absolute bottom-0 right-0 w-28 h-28 xs:w-32 xs:h-32 sm:w-40 sm:h-40 bg-[#B22222] rounded-full blur-3xl"></div>
            </div>
            ...
            <div className="container mx-auto px-4 xs:px-5 sm:px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-5 xs:gap-6 sm:gap-6 md:gap-7 lg:gap-8 mb-6 sm:mb-8">
                    <div className="xs:col-span-2 md:col-span-1 lg:col-span-1">
                        <div className="flex items-center mb-3 xs:mb-4 sm:mb-4">
                            <h3 className="text-lg xs:text-xl sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-[#800000] to-[#B22222] bg-clip-text text-transparent font-serif">
                                Sonia<span className="text-[#B22222]">Property</span>
                            </h3>
                        </div>
                        <p className="text-gray-400 mb-4 xs:mb-5 sm:mb-6 leading-relaxed text-xs xs:text-sm sm:text-base font-sans">
                        ...
                        <ul className="space-y-1.5 xs:space-y-2 sm:space-y-2 md:space-y-3">
                            {[
                                ...
                                return (
                                    <li key={index}>
                                        {isActive ? (
                                            <span className="text-[#D4AF37] flex items-center cursor-default text-xs xs:text-sm sm:text-sm md:text-base font-sans">
                                            ...
                                            <Link
                                                to={item.path}
                                                className="text-gray-400 hover:text-[#D4AF37] transition-all duration-300 flex items-center group text-xs xs:text-sm sm:text-sm md:text-base font-sans"
                                            >
                                                <FontAwesomeIcon icon={faChevronRight} className="w-3 h-3 xs:w-3 xs:h-3 sm:w-4 sm:h-4" />
                        ...
                        <address className="not-italic">
                            <ul className="space-y-2 xs:space-y-2.5 sm:space-y-3 md:space-y-4">
                                <li className="flex items-start">
                                    <div className="bg-gradient-to-r from-[#800000] to-[#B22222] p-1 xs:p-1.5 sm:p-1.5 md:p-2 rounded-lg mr-2 xs:mr-2.5 sm:mr-3 mt-0.5 flex-shrink-0">
                                        <FontAwesomeIcon icon={faMapMarkerAlt} className="w-3 h-3 xs:w-3.5 xs:h-3.5 sm:w-4 sm:h-4" />
                                    </div>
                                    <div>
                                        <span className="text-gray-400 block text-xs xs:text-sm sm:text-sm md:text-base font-sans">Jl. Kavling Raya No.83</span>
                                        <span className="text-gray-400 text-xs xs:text-sm sm:text-sm md:text-base font-sans">Adidharma, Gunungjati, Cirebon 45151</span>
                                    </div>
                                </li>
                                <li className="flex items-center">
                                    <div className="bg-gradient-to-r from-[#800000] to-[#B22222] p-1 xs:p-1.5 sm:p-1.5 md:p-2 rounded-lg mr-2 xs:mr-2.5 sm:mr-3 flex-shrink-0">
                                ...
                                <li className="flex items-center">
                                    ...
                                    <div>
                                        <a href="mailto:soniaproperty.assetmanagement@gmail.com" className="text-gray-400 hover:text-[#D4AF37] transition-colors text-xs xs:text-sm sm:text-sm md:text-base font-sans break-all">
                    ...
                    <div className="mt-4 xs:mt-0 xs:col-span-2 md:col-span-1">
                        ...
                        <ul className="space-y-1.5 xs:space-y-2 sm:space-y-2 md:space-y-3 text-xs xs:text-sm sm:text-sm md:text-base font-sans">
                            <li className="flex justify-between text-gray-400">
                                ...
                                <span className="text-[#D4AF37]">09.00 – 16.00</span>
                            </li>
                            <li className="flex justify-between text-gray-400">
                                <span>Sabtu</span>
                ...
                <div className="border-t border-gray-700 pt-4 xs:pt-5 sm:pt-6 md:pt-8 flex flex-col xs:flex-row justify-between items-center">
                    <div className="text-gray-400 text-xs mb-2 xs:mb-0 font-sans text-center xs:text-left">

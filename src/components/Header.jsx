                    ...
                    <div className="flex items-center">
                        ...
                        >
                            ...
                            <div className="flex flex-col leading-tight">
                                {/* SONIA - Ukuran diperkecil untuk mobile */}
                                <h1 className="font-script text-xl xs:text-2xl sm:text-3xl lg:text-4xl font-semibold 
                   bg-gradient-to-r from-[#C2185B] to-[#E91E63] bg-clip-text text-transparent">
                                    Sonia
                                </h1>

                                {/* PROPERTY & ASSET MANAGEMENT - Ukuran diperkecil untuk mobile */}
                                <span className="font-mont font-semibold uppercase text-[9px] xs:text-[10px] sm:text-[11px] 
